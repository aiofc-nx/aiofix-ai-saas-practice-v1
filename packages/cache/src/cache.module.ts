...
// 导入配置
import { CacheConfig, getCacheConfigFromAiofixConfig } from './config/cache.config';
      ...
      providers: [
        // 配置提供者
        {
          ...
          useFactory: (configService: ConfigService) => {
            const aiofixConfig = getCacheConfigFromAiofixConfig(configService);
            return {
              ...aiofixConfig,
              ...config,
            };
        ...
        // 缓存拦截器配置
        {
          ...
          useFactory: (configService: ConfigService) => {
            ...
            return {
              ...
              defaultTtl: aiofixConfig.memory.defaultTtl || 3600000,
