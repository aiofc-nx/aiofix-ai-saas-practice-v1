...
import { FastifyInstance, ILoggerService } from '../types';
...
export class CorsPlugin extends CoreFastifyPlugin {
   ...
   * 获取自定义指标
   */
  protected override async getCustomMetrics(): Promise<
  ...
  private sanitizeOptionsForLog(): Record<string, unknown> {
    ...
    return {
      ...
      methodsCount: Array.isArray(options.methods)
