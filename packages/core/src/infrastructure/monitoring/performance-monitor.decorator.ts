 ...
 * @returns 方法装饰器
 */
export function PerformanceMonitorMethod(
  options: IPerformanceMonitorOptions,
): MethodDecorator {
 ...
 * @returns 类装饰器
 */
export function PerformanceMonitorClass(
  options: IPerformanceMonitorOptions,
): ClassDecorator {
 ...
 * @returns 方法装饰器
 */
export function ResponseTimeMonitor(
  metricName: string,
 ...
 * @returns 是否有性能监控元数据
 */
export function hasPerformanceMonitorMetadata(
  target: any,
  propertyKey?: string | symbol,
): boolean {
